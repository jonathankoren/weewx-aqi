    ...
    def __init__(self):
        super(AirQualityIndexInstaller, self).__init__(
            ...
            files=[('bin/user',
                    ...
                    'bin/user/aqi/ca.py', 'bin/user/aqi/calculators.py',
                    'bin/user/aqi/india.py', 'bin/user/aqi/mx.py',
                    'bin/user/aqi/service.py', 'bin/user/aqi/standards.py',
                    'bin/user/aqi/uk.py', 'bin/user/aqi/units.py',
                    'bin/user/aqi/us.py' ]),
                ('bin',
                    [ 'bin/aqi_backfill' ])
            ]
